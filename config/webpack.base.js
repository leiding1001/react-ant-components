...
const config = require('./pre-build-config');
...
const COMMON_LIB_DIR_PATH = pathLib.resolve(ROOT_PATH, 'src/js/common/lib');
...
const OUTPUT_PATH = pathLib.resolve(ROOT_PATH, buildOutPathDir);
...
console.log('AntD主题配置: ', JSON.stringify(theme));
console.log('__ROUTES__: ', routePath);
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        include: [
          pathLib.resolve(ROOT_PATH, 'node_modules/react-viewer'),
          SOURCE_PATH
        ],
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      growingIOKey,
      productHost,
      chunks: ["manifest", "runtime", "shim", "public", 'index'],
